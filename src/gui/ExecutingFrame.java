...
public class ExecutingFrame {
			...
			for (int i = 0; i < rounds; i++) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null,
							"Fehler bei der Ausf�hrung.", "Fehler",
	...
	private void showSolutionFrame(final Matcher matcher) {
		...
		JLabel optionLabel = new JLabel(
				"Es wurde eine L�sung gefunden. Sie haben folgende M�glichkeiten: ");
	...
	private void showNoSolutionFrame() {
		...
		textLabel.setText("Konnte keine L�sung finden. M�glich Optionen: ");

		JLabel lineOneLabel = new JLabel();
		noSolutionFrame.add(lineOneLabel);
		lineOneLabel.setText("- Bieten Sie mehr Slots/R�ume an ");

		JLabel lineTwoLabel = new JLabel();
		noSolutionFrame.add(lineTwoLabel);
		lineTwoLabel
				.setText("- �ndern Sie die Einstellungen zu Notar oder Moderator");

		JLabel lineThreeLabel = new JLabel();
		noSolutionFrame.add(lineThreeLabel);
		lineThreeLabel
				.setText("- F�hren Sie die Berechnung erneut mit mehr Wiederholungen durch");
